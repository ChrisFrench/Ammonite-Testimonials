...
class TestimonialsModelTools extends TestimonialsModelBase 
{	
    protected function _buildQueryWhere(&$query)
    {
		...
		$query->where("LOWER(tbl.folder) = 'testimonials'");
	...
	public function getList($refresh = false)
	{
		if ($list = parent::getList($refresh)) 
		{
		    ...
		    {
		        $item->link = 'index.php?option=com_testimonials&view=tools&task=view&id='.$item->id;
		    }		    
		} 
