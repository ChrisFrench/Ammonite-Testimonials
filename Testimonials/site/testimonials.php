...
$options = array( 'site'=>'site', 'type'=>'components', 'ext'=>'com_testimonials' );

// Require the base controller
Testimonials::load( 'TestimonialsController', 'controller', $options );

// Require specific controller if requested
$controller = JRequest::getWord('controller', JRequest::getVar( 'view' ) );
if (!Testimonials::load( 'TestimonialsController'.$controller, "controllers.$controller", $options ))
    $controller = '';
